Shader "XCTS_Experimental-A01/Transparent_V0.0.3"
{
    Properties
    {
        [Header(Base Color)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings i): SV_Target
            {
                ...
                //-------边缘光计算-------
                float linear01RimLightFactor = smoothstep(0.5 - _RimLightSmoothstep * 0.5, 0.5 + _RimLightSmoothstep * 0.5, (1 - saturate(NdotV - _RimLightBias * 0.5))) * _RimLightIntensity;
