Shader "XCTS_Experimental-A01/Opaque_V0.0.5"
{
    Properties
    {
        [Header(Base Color)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings i): SV_Target
            {
                ...
                float3 finalEnvironmentReflectionColor = _LightingMode * float3Lerp(environmentCube, float3(0, 0, 0), roughness) * floatLerp(1, pow(saturate(1 - NdotV), 1), 0.75);
