Shader "XCTS_Experimental-A01/Opaque_V0.0.2"
{
    Properties
    {
        [Header(Base Color)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings i): SV_Target
            {
                ...
                float2 screenUVTranslation = ComputeScreenPos(TransformWorldToHClip(i.positionWS + normal * (0.1 + _RimLightBias * 0.1))).xy / i.positionSS.w;
                ...
                float linear01Depth = Linear01Depth(SAMPLE_TEXTURE2D(_CameraDepthTexture, textureSampler1, screenUV).r, _ZBufferParams);
                float linear01DepthTranslation = Linear01Depth(SAMPLE_TEXTURE2D(_CameraDepthTexture, textureSampler1, screenUVTranslation).r, _ZBufferParams);
