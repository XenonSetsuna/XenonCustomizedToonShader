Shader "XCTS_Experimental-A01/Transparent_V0.0.5"
{
    Properties
    {
        [Header(Base Color)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings i): SV_Target
            {
                ...
                float3 finalEnvironmentReflectionColor = _LightingMode * float3Lerp(environmentCube, float3(0, 0, 0), roughness) * pow(saturate(1 - NdotV), roughness);
